  ...
  return (
    ...
    >
      ...
      />
       ...
       <input 
        type="text"
        className={`border outline-none w-full bg-white truncate rounded-lg text-black ${isTodoEditable ? "border-black/10 px-2" : "border-transparent"} ${todo.completed ? "line-through" : ""}`}
        value ={todoMsg}
